For any positive integer $n$, let $\mathbb{N}_n$ be the set whose elements are the integers $1, 2, ...,n$; let $\mathbb{N}$ be the set consisting of all positive integers. For any set $A$, we say:
